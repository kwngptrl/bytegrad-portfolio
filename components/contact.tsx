  ...
  return (
    ...
    viewport={{
        ...
        >
            ...
            <textarea className='h-52 my-3 rounded-lg borderBlack p-4 dark:bg-white dark:bg-opacity-80 dark:focus:bg-opacity-100 transition-all dark:outline-none' name="message" required maxLength={5000} placeholder='Your message'/>{/* name="" id="" cols="30" rows="10"></textarea> */}
            <SubmitBtn />
        </form>
    </motion.section>
  )
